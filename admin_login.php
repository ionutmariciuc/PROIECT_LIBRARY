...
<body>
  ...
  <section>
    <div class="log_img">
      ...
      <div class="box1">
        ...
        <h1 style="text-align: center; font-size: 35px;font-family: Lucida Console;">LOGIN ADMIN</h1>
        ...
        <form name="login" action="" method="post">
          ...
          <p style="color: white; padding-left: 15px;">
            ...
            <a style="color: white;" href="inregistrare_admin.php">inregistrare</a>
          </p>
        </form>
      </div>
    </div>
  ...
  if (isset($_POST['submit'])) {
    ...
    $var = 0;
    $res = mysqli_query($db, "SELECT *FROM admin WHERE username='$_POST[username]'&&password='$password'");
